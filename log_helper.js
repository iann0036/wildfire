...
function populateEvents(result) {
    ...
    for (var i=0; events!=null && i<events.length; i++) {
        ...
        */
        ...
        if (events[i].evt!="begin_recording" && events[i].evt!="end_recording" && !simulation_log) {
